...
extension ViewController : PNObjectEventListener {
    ...
    func client(client: PubNub!, didReceiveMessage message: PNMessageResult!) {
        /*
        Note:
        This is hardcoded as another user right now, in the future you will want to find a way to
        figure out who the sender actually is.  I have already done this on my other project so if 
        you want to wait a few days I'll update it with how I did it, but it's already 12:30 AM and I am 
        tired from trying to figure this out all day so deal with it.
        */
